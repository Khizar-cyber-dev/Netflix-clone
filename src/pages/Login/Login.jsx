...
//                     <input type="text" placeholder="Enter your Name" value={name} onChange={(e)=> { setName(e.target.value) }} className='w-100 h-[50px] bg-[#333] text-white my-[12px] mx-0 border-0 outline-0 py-[16px] px-[20px] text-md font-bold' required/>
//                     <input type="email" placeholder='Email' value={email} onChange={(e)=> { setEmail(e.target.value) }} className='w-100 h-[50px] bg-[#333] text-white my-[12px] mx-0 border-0 outline-0 py-[16px] px-[20px] text-md font-bold' required/>
//                     <input type="password" placeholder='Password' value={password} onChange={(e)=> { setPassword(e.target.value) }} className='w-100 h-[50px] bg-[#333] text-white my-[12px] mx-0 border-0 outline-0 py-[16px] px-[20px] text-md font-bold' required/>
